...
public class DividendProjectApplication {
    ...
    public static void main(String[] args) {
        ...
        Connection con
                = Jsoup.connect("https://finance.yahoo.com/quote/COKE/history?period1=1646492170&period2=1678028170&interval=1mo&filter=history&frequency=1mo&includeAdjustedClose=true");
        try {
